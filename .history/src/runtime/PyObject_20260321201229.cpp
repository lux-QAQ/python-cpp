...
PyResult<int32_t> PyObject::init_raw(std::span<Value> args, PyDict *kwargs)
{
    ...
    spdlog::debug("[Object::init_raw] obj={:p} (type={}), found_init={}, argc={}",
        (void *)this,
        type()->name(),
        found == LookupAttrResult::FOUND,
        args.size());
    ...
    if (found == LookupAttrResult::FOUND) {
        ...
        spdlog::debug("[Object::init_raw] __init__ call successful");
        return Ok(0);
    }

    spdlog::debug("[Object::init_raw] No __init__ found, skipping");
    return Ok(0);
}
