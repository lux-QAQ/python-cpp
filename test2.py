...
def returndict(a):
    return {"funcfunc":a}
def test2():
    dic = {999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999:returndict}
    a=[1,2,dic]
    c=a[2][999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999](returndict)["funcfunc"](funcfunc)["funcfunc"](999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)
    b= funcfunc
    if c==b:
        return True
    else:
