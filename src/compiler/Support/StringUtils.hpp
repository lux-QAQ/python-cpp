...
[[nodiscard]] inline std::vector<std::string_view>
	split_n(std::string_view s, char delim, size_t max_parts)
{
	std::vector<std::string_view> result;
	size_t start = 0;
...
template<size_t N>
[[nodiscard]] std::optional<std::array<std::string_view, N>> split_exact(std::string_view s,
	char delim)
{
...
/// 分割并要求至少 N 段
[[nodiscard]] inline std::optional<std::vector<std::string_view>>
	split_at_least(std::string_view s, char delim, size_t min_parts)
{
	auto parts = split(s, delim);
...
[[nodiscard]] inline std::optional<std::string_view> strip_prefix(std::string_view s,
...
[[nodiscard]] inline std::optional<std::string_view> strip_suffix(std::string_view s,
...
[[nodiscard]] inline std::string join(const std::vector<std::string_view> &parts,
	std::string_view sep)
{
...
template<size_t N>
[[nodiscard]] std::string join(const std::array<std::string_view, N> &parts, std::string_view sep)
{
...
[[nodiscard]] inline std::string
	replace_all(std::string_view s, std::string_view from, std::string_view to)
{
